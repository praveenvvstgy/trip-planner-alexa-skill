...
def create_current_city_attributes(city):
...
def get_trip_from_session(intent, session):
	...
	if 'city' in intent['slots']:
		...
		session_attributes = create_favorite_color_attributes(favorite_color)
		speech_output = "Here is your trip iternary for " + \
						city + \
						"Yout trip includes " + ", ".join(planner.get_route_sequence(city))
...
def on_intent(intent_request, session):
	...
	elif intent_name == "FullDayTripIntent":
